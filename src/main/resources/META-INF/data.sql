...
INSERT INTO books(id, title, rating, description, publisher_id, category_id, pages) VALUES (1, 'O Javie', 7, 'Thinking in Java', 3, 1, 14);
INSERT INTO books(id, title, rating, description, publisher_id, category_id, pages) VALUES (2, 'O C++', 8, 'Thinking in C++', 3, 1, 13);
...
INSERT INTO books(id, title, rating, description, publisher_id, category_id, pages) VALUES (5, 'O SQL', 8, 'Thinking in SQL', 3, 1, 12);
